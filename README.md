# Supplementary Materials: MAXIMUM-VARIANCE-REDUCTION STRATIFICATION FOR IMPROVED SUBSAMPLING

This document provides a overview of the code accompanying the paper: **"MAXIMUM-VARIANCE-REDUCTION STRATIFICATION FOR IMPROVED SUBSAMPLING"**. 
...
Execute the main scripts to generate the raw simulation results. 

Execute `Plot.R` to generate the figures.